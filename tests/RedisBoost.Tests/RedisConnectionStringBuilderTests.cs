...
namespace RedisBoost.Tests
{
    ...
    public class RedisConnectionStringBuilderTests
    {
        ...
        {
            var cs = new RedisConnectionStringBuilder("127.0.0.1");
        ...
        {
            var cs = new RedisConnectionStringBuilder("127.0.0.1", 2312);
        ...
        {
            var cs = new RedisConnectionStringBuilder("127.0.0.1", dbIndex: 23);
